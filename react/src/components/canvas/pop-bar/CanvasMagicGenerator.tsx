        ...
        try {
            ...
            fileIds.forEach((fileId, index) => {
                ...
                console.log(`[CanvasMagicGenerator] 文件${index + 1} (${fileId}):`, {
                    ...
                    dataURLPreview: file && file.dataURL ? file.dataURL.substring(0, 50) + '...' : 'no dataURL'
                });
            ...
            if (remoteFileIds.length > 0) {
                ...
                try {
                    for (let i = 0; i < remoteFileIds.length; i++) {
                        ...
                        console.log(`[CanvasMagicGenerator] 下载进度: ${i + 1}/${remoteFileIds.length} - ${file.dataURL}`);
            ...
            if (hasImages && fileIds.length > 0) {
                ...
                console.log('[CanvasMagicGenerator] Canvas导出成功，尺寸:', canvas.width, 'x', canvas.height);
            ...
            console.log('[CanvasMagicGenerator] 准备发送事件:', eventData.fileId, '尺寸:', width, 'x', height);
            ...
            console.error('[CanvasMagicGenerator] 错误堆栈:', error instanceof Error ? error.stack : '无堆栈信息');
